...
const renderOld=get('renderCallYourNameSourcePulse164'),renderNew=(()=>{const n=newFns.get('renderCallYourNameSourcePulse164');return mainText.slice(n.start,n.end)})();
